...
# Поправка на руление, минуты. Фиды аэропортов понимают revisedTime по-разному:
# Шереметьево даёт отход от гейта, Внуково и частично Домодедово — отрыв от полосы,
# то есть с рулением внутри. Без поправки аэропорты между собой несравнимы.
#
# Числа — медиана отклонения факта от плана за июнь-август 2026, 60 884 рейса.
# Признак, что это руление, а не реальное опоздание: в Шереметьеве каждый
# двадцатый рейс уходит на 7 и более минут раньше плана, а во Внукове раньше
# плана не уходит никто: нижние 5% это уже +7 минут.
#
# Пересматривать раз в квартал вручную. Скользящую медиану здесь брать нельзя:
# она съест реальное ухудшение, если аэропорт начнёт стабильно опаздывать.
TAXI_OFFSET = {"SVO": 0, "DME": 12, "VKO": 31}
